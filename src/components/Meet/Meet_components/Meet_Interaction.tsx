...
function Meet_Interaction({ isSupply, isBorrow }: MeetInteractionProps) {
    ...
    return (
        <div ref={svgRef} className='block rounded-2xl overflow-hidden'>
            <div className='inline-block max-w-full align-top svg mt-12 bg-announcements'>
                <motion.svg  xmlns="http://www.w3.org/2000/svg" width="986" height="450" viewBox="0 0 986 450" fill="none"
                initial={{opacity:0}}
                animate={{opacity: 1}}
