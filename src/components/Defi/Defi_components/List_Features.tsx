...
function List_Features() {
  return (
    <>
        <div className='grid grid-cols-2 items-center gap-x-10 rounded-2xl p-8'>
        ...
        <div className='grid grid-cols-2 items-center gap-x-10 rounded-2xl p-8 bg-backgroundGray'>
            <div className='flex items-center gap-x-4 font-medium'>
                <Transparent_Icon/>
                <h3>
                    Transparent
