...
function Brand_Sg() {
  return (
    ...
    >
        <rect rx="8" width="256" height="256" fill="#9696FF"></rect>
        <path
        ...
        >
            <g
            style={{ transform: 'rotate(45deg)', transformOrigin: '240px -25.9986px' }}
            >
            <path
            ...
            <g
            style={{ transform: 'rotate(-90deg)', transformOrigin: '239.999px -25.9993px' }}
            >
            <path
        ...
        >
            <g
            style={{ transform: 'rotate(45deg)', transformOrigin: '16.0017px 281.997px' }}
            >
            <path
            ...
            <g
            style={{ transform: 'rotate(-90deg)', transformOrigin: '16.0013px 281.997px' }}
            >
            <path
        ...
        <g opacity="0" style={{ transform: 'scale(0.5) rotate(-135deg)', transformOrigin: '128px 128px' }}>
        <path
        ...
        <g style={{ transform: 'translateY(216px)', transformOrigin: '127px 168px' }}>
        <g style={{ transform: 'rotate(-180deg)', transformOrigin: '127px 104px' }}>
            <path
        ...
        <g style={{ transform: 'rotate(180deg)', transformOrigin: '127px 232px' }}>
            <path
        ...
        <g style={{ transform: 'translateY(192px)', transformOrigin: '127.5px 191px' }}>
