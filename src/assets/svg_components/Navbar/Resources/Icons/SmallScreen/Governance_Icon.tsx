...
function Governance_Icon() {
  return (
    ...
    >
        ...
        <rect x="13" y="25" width="5" height="11" rx="2" fill="#5589c5"></rect>
        <rect x="21" y="25" width="5" height="11" rx="2" fill="#5589c5"></rect>
        <rect x="29" y="25" width="5" height="11" rx="2" fill="#5589c5"></rect>
        <path
