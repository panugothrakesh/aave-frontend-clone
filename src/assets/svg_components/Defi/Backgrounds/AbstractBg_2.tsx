...
function AbstractBg_2() {
  ...
  const controls3 = useAnimation();
    ...
    useEffect(() => {
      if (isInView) {
        ...
        // Third animation with another delay override
        controls3.start({
          scale: 1,
  ...
  >
    <motion.g initial="hidden" animate="show" variants={reveal} transform="translate(0 0)" style={{ transformOrigin: '147px 0px' }}>
      <motion.g initial='initial' animate={controls1} style={{ scale: '0', transformOrigin: '147px 0px' }}>
      ...
      <g style={{ transformOrigin: '147px 0px' }}>
        <motion.g initial='initial' animate={controls2} style={{scale: '0', transformOrigin: '147px 0px' }}>
          <circle
            mask="url(#defi-stake-circle-mask-1)"
            cx="147"
            r="121"
      ...
      <g style={{ transformOrigin: '147px 0px' }}>
        <motion.g initial='initial' animate={controls3} style={{scale: '0', transformOrigin: '147px 0px' }}>
          <circle
            mask="url(#defi-stake-circle-mask-1)"
            cx="147"
            r="71"
